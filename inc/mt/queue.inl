...
// template<typename T, typename WithPrivilage, typename Container>
// BlockingBoundedQueue<T, WithPrivilage, Container>::BlockingBoundedQueue(size_t capacity)
// : capacity_{capacity}
// {
// }

// template<typename T, typename WithPrivilage, typename Container>
// void BlockingBoundedQueue<T, WithPrivilage, Container>::enqueue(T const& new_val)
// {
...
// template<typename T, typename WithPrivilage, typename Container>
// void BlockingBoundedQueue<T, WithPrivilage, Container>::enqueue(T&& new_val)
// {
//     std::unique_lock<std::mutex> lock(mtx_);
//     not_full_.wait(lock, [this] { return !(Container::size() == capacity_); });
...
// template<typename T, typename WithPrivilage, typename Container>
// void BlockingBoundedQueue<T, WithPrivilage, Container>::enqueue_front(T const& new_val)
// {
//     std::unique_lock<std::mutex> lock(mtx_);
//     not_full_.wait(lock, [this] { return !(Container::size() == capacity_); });
...
// template<typename T, typename WithPrivilage, typename Container>
// void BlockingBoundedQueue<T, WithPrivilage, Container>::enqueue_front(T&& new_val)
// {
//     std::unique_lock<std::mutex> lock(mtx_);
//     not_full_.wait(lock, [this] { return !(Container::size() == capacity_); });
...
// // template<typename T, typename WithPrivilage, typename Container>
// // void BlockingBoundedQueue<T, WithPrivilage, Container>::dequeue(T& new_val)
// // {
// //     std::unique_lock<std::mutex> lock(mtx_);
...
// template<typename T, typename WithPrivilage, typename Container>
// bool BlockingBoundedQueue<T, WithPrivilage, Container>::empty() const noexcept
// {
//     std::unique_lock<std::mutex> lock(mtx_);
...
// template<typename T, typename WithPrivilage, typename Container>
// bool BlockingBoundedQueue<T, WithPrivilage, Container>::full() const noexcept
// {
//     return size() == capacity_;
// }

// template<typename T, typename WithPrivilage, typename Container>
// size_t BlockingBoundedQueue<T, WithPrivilage, Container>::size() const noexcept
// {
//     std::unique_lock<std::mutex> lock(mtx_);
...
// template<typename T, typename WithPrivilage, typename Container>
// size_t BlockingBoundedQueue<T, WithPrivilage, Container>::capacity() const noexcept
// {
//     return capacity_;
// }
